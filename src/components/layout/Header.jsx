        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={logout}
              title="Switch user"
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-stone-500 hover:text-indigo-600 hover:bg-indigo-50 rounded-[5px] border border-stone-200 hover:border-indigo-200 transition-colors"
            >
